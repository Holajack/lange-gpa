...
const SUBJECT_OVERRIDES = {
  ...
  // --- authentic Phase 1A additions (prepositions/verbs/adjectives need explicit subjects) ---
  "color-red": "a solid bright red colour swatch, rounded square",
  "color-blue": "a solid bright blue colour swatch, rounded square",
  "color-yellow": "a solid bright yellow colour swatch, rounded square",
  "color-green": "a solid bright green colour swatch, rounded square",
  "color-white": "a solid white colour swatch with a thin grey outline",
  "color-black": "a solid black colour swatch, rounded square",
  "color-brown": "a solid brown colour swatch, rounded square",
  "color-orange": "a solid bright orange colour swatch, rounded square",
  "color-pink": "a solid pink colour swatch, rounded square",
  "color-purple": "a solid purple colour swatch, rounded square",
  "num-one": "a single big apple, the numeral 1 feeling, one object",
  "num-two": "two identical apples side by side",
  "num-three": "three identical apples in a row",
  "num-four": "four identical apples grouped",
  "num-five": "five identical apples grouped",
  "num-six": "six identical apples grouped",
  "num-seven": "seven identical apples grouped",
  "num-eight": "eight identical apples grouped",
  "num-nine": "nine identical apples grouped",
  "num-ten": "ten identical apples grouped in two rows of five",
  "cloth-shirt": "a single short-sleeve t-shirt, flat sticker",
  "cloth-pants": "a pair of blue jeans trousers, flat sticker",
  "cloth-shoes": "a pair of sneakers shoes, flat sticker",
  "cloth-socks": "a pair of socks, flat sticker",
  "cloth-hat": "a cap hat, flat sticker",
  "cloth-coat": "a winter coat, flat sticker",
  "cloth-dress": "a simple dress, flat sticker",
  "cloth-scarf": "a wool scarf, flat sticker",
  "cloth-gloves": "a pair of gloves, flat sticker",
  "cloth-jacket": "a denim jacket, flat sticker",
  "prep-on": "a small red ball resting ON TOP of a closed brown box",
  "prep-under": "a small red ball UNDERNEATH a brown table, ball below",
  "prep-in": "a small red ball INSIDE an open brown box",
  "prep-behind": "a small red ball partly hidden BEHIND a brown box",
  "prep-infront": "a small red ball IN FRONT of a brown box, ball nearer",
  "prep-above": "a small red ball floating ABOVE a brown box with a gap",
  "prep-beside": "a small red ball BESIDE a brown box, touching its side",
  "prep-between": "a small red ball BETWEEN two brown boxes",
  "emo-happy": "a simple round cartoon face smiling happily",
  "emo-sad": "a simple round cartoon face looking sad, single tear",
  "emo-angry": "a simple round cartoon face looking angry, furrowed brows",
  "emo-surprised": "a simple round cartoon face surprised, open mouth wide eyes",
  "emo-scared": "a simple round cartoon face looking frightened",
  "emo-sleepy": "a simple round cartoon face sleepy, half-closed eyes",
  "emo-crying": "a simple round cartoon face crying with tears",
  "emo-laughing": "a simple round cartoon face laughing hard",
  "tbl-knife": "a single table knife, flat sticker",
  "tbl-fork": "a single dinner fork, flat sticker",
  "tbl-spoon": "a single spoon, flat sticker",
  "tbl-plate": "a single empty round dinner plate, top view",
  "tbl-bowl": "a single empty bowl, flat sticker",
  "tbl-pot": "a cooking pot with a lid, flat sticker",
  "tool-hammer": "a single claw hammer, flat sticker",
  "tool-saw": "a single hand saw, flat sticker",
  "tool-scissors": "a single pair of scissors, flat sticker",
  "tool-screwdriver": "a single screwdriver, flat sticker",
  "tool-wrench": "a single wrench, flat sticker",
  "tool-nail": "a single metal nail, flat sticker",
  "tool-rope": "a coil of rope, flat sticker",
  "room-wall": "a plain interior wall of a room",
  "room-floor": "a wooden floor of a room, looking down",
  "room-ceiling": "the ceiling of a room with a light, looking up",
  "room-roof": "the roof of a house, exterior",
  "room-stairs": "an indoor staircase",
  "room-shelf": "a wall shelf with a few books",
  "rooms-kitchen": "a simple kitchen with counter and stove",
  "rooms-bedroom": "a simple bedroom with a bed",
  "rooms-bathroom": "a simple bathroom with toilet and sink",
  "rooms-living": "a simple living room with a sofa",
  "fam-son": "a young boy standing, a son, simple figure",
  "fam-daughter": "a young girl standing, a daughter, simple figure",
  "fam-brother": "two boys standing together, brothers",
  "fam-sister": "two girls standing together, sisters",
  "fam-husband": "an adult man, a husband, simple figure",
  "fam-wife": "an adult woman, a wife, simple figure",
  "body-leg": "a simple human figure with an arrow pointing to the leg",
  "body-arm": "a simple human figure with an arrow pointing to the arm",
  "body-finger": "a hand with an arrow pointing to one finger",
  "body-knee": "a bent leg with an arrow pointing to the knee",
  "body-shoulder": "a simple figure with an arrow pointing to the shoulder",
  "body-neck": "a simple figure with an arrow pointing to the neck",
  "body-back": "a simple figure seen from behind, arrow to the back",
  "body-stomach": "a simple figure with an arrow pointing to the belly",
  "adj-big": "a big elephant beside a tiny mouse, the elephant emphasised",
  "adj-small": "a tiny mouse beside a big elephant, the mouse emphasised",
  "adj-hot": "a steaming hot cup of tea with heat waves",
  "adj-cold": "a glass with ice cubes, frost, cold",
  "adj-old": "an old worn cracked object next to nothing, aged",
  "adj-new": "a shiny brand-new object with sparkles",
  "adj-long": "one long pencil emphasised next to a short one",
  "adj-short": "one short pencil emphasised next to a long one",
  "adj-heavy": "a heavy big rock, straining, heavy",
  "adj-fast": "a running figure with speed lines, fast",
  "state-hungry": "a person holding their empty stomach, hungry",
  "state-thirsty": "a person reaching for water, thirsty, dry",
  "state-tired": "a person slumping, tired and worn out",
  "state-sick": "a person in bed with a thermometer, sick",
  "state-dirty": "a child with muddy dirty hands",
  "state-clean": "clean washed hands with soap bubbles",
  "bug-fly": "a single housefly insect, flat sticker",
  "bug-spider": "a single spider, flat sticker",
  "bug-bee": "a single honeybee, flat sticker",
  "bug-ant": "a single ant, flat sticker",
  "bug-snake": "a single coiled snake, flat sticker",
  "animal-duck": "a single duck, flat sticker",
  "animal-goat": "a single goat, flat sticker",
  "animal-pig": "a single pig, flat sticker",
  "animal-elephant": "a single elephant, flat sticker",
  "animal-lion": "a single lion, flat sticker",
  "animal-goose": "a single goose, flat sticker",
  "nat-cloud": "a single white cloud in a blue sky",
  "nat-grass": "a patch of green grass",
  "nat-forest": "a small forest of pine trees",
  "nat-river": "a winding river through land",
  "nat-hill": "a single rounded green hill",
  "nat-lake": "a calm blue lake",
  "nat-sky": "a wide blue sky with a sun",
  "drink-tea": "a hot cup of tea, flat sticker",
  "drink-juice": "a glass of orange juice, flat sticker",
  "verb-pour": "a hand tipping a jug, water pouring into a glass",
  "verb-cut": "a knife cutting a vegetable on a board",
  "verb-throw": "a person throwing a ball forward",
  "verb-catch": "a person catching a ball with both hands",
  "verb-push": "a person pushing a big box forward",
  "verb-pull": "a person pulling a rope toward themselves",
  "verb-turn": "a hand turning a round door knob, rotation arrows",
  "verb-read": "a person reading an open book",
  "verb-write": "a hand writing with a pen on paper",
  "verb-draw": "a hand drawing a picture with a crayon",
  "verb-look": "a person looking at something, hand over brow",
  "verb-hold": "two hands holding a small object",
  "verb-carry": "a person carrying a heavy bag",
  "verb-climb": "a person climbing a ladder",
  "verb-ride": "a person riding a horse",
  "verb-see": "an eye with lines showing it sees an object",
  "verb-want": "a person reaching out wanting an object held away",
  "verb-listen": "a person cupping their ear to listen, sound waves",
  "verb-touch": "a finger touching the surface of an object",
  "verb-kick": "a person kicking a ball with their foot",
};
